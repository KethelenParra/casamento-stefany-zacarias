...
import { CheckCircle, ArrowRight, Phone, Gift, RefreshCw, AlertCircle } from 'lucide-react';
      ...
      <div className="text-center py-10 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-stone-500 text-sm font-light">
            O seu novo presente é <span className="font-bold text-[#721C24]">{exchangeNewGift?.name}</span>. Obrigado!
          </p>
        </div>
